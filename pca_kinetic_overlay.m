...
fprintf('\n');
disp('--> PCA kinetic overlay start');
fprintf('\n');
...
% Save plot.
savefig('pca_kinetic_overlay.fig');
print('-dbmp', 'pca_kinetic_overlay.bmp');
