...
% code, older version might trigger errors. Fix 'bar', vary 'pol'.
%
% This software may be used, modified, and distributed freely, but this
% header may not be modified and must appear at the top of this file.
%--------------------------------------------------------------------------

function kinetic_whisker_bar_filter(x_min, x_max, y_min)
...
fprintf('\n');
disp('--> Kinetic whisker bar filter start');
fprintf('\n');
...
cdir = 'kinetic_whisker_bar_filter';
...
fprintf('\n');
disp('--> Kinetic whisker bar filter end');
fprintf('\n');
