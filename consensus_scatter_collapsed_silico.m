...
function consensus_scatter_collapsed_silico(num_iter)
...
fprintf('\n');
disp('--> Consensus scatter collapsed silico start');
fprintf('\n');
...
cdir = 'consesnsus_scatter_collapsed_silico';
...
% Save plot.
fn = 'consensus_scatter_collapsed_silico';
savefig([fn, '.fig']);
print('-dbmp', [fn, '.bmp']);
...
disp('--> Consensus scatter collapsed silico end');
fprintf('\n');
