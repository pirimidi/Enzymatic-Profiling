...
function barcode_all_unique_count_96(x_min, x_max, y_min)
...
fprintf('\n');
disp('--> Barcode all unique count 96 start');
fprintf('\n');
...
cdir = 'barcode_all_unique_count_96';
...
fprintf('\n');
disp('--> Barcode all unique count 96 end');
fprintf('\n');
