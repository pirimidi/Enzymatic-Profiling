...
function consensus_cumulative_stop_pol
...
fprintf('\n');
disp('--> Consensus cumulative stop pol start');
fprintf('\n');
...
cdir = 'consensus_cumulative_stop_pol';
...
% Iterate through all 'pol' folders.
 for e = 1:length(list) 
    ...
    grid;
    title('consensus cumulative identity stop pol');
...
disp('--> Consensus cumulative stop pol end');
fprintf('\n');
