...
function barcode_unique_hits_3(x_min, x_max, y_min)
...
fprintf('\n');
disp('--> Barcode unique hits 3 start');
fprintf('\n');
 ...
 for e = 1:length(list) 
    ...
    for exp = 1:length(cons_list(1).experiment)
        ...
        if length(BC) >= 3
            ...
            % Save plot.
            fn = [num2str(e), '-', num2str(exp), '_bar_unique_hits_3'];
            savefig([fn, '.fig']);
            print('-dbmp', [fn, '.bmp']);
