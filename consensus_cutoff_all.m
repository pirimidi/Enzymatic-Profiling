...
fprintf('\n');
disp('--> Consensus cutoff polymerase fix start');
fprintf('\n');
    ...
    for bar = 1:length(barcodes)  
       ...
       % Define array container for fixed 'bar' and grouping variable array.
        ...
        for exp = 1:length(cons_list(bar).experiment)
            ...
            ge = [ge; align_copies(1:length(norm))'];
        ...
        grid;
        title('consensus identity iteration-cutoff-all-cons');
...
disp('--> Consensus cutoff polymerase fix end');
fprintf('\n');
