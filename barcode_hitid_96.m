...
function barcode_hitid_96(x_min, x_max, y_min)
...
% Iterate through all MAT-files (currently only one).
 for e = 1:length(list) 
    ...
    for exp = 1:length(cons_list(1).experiment)
        ...
        % Save plot.
        fn = [num2str(exp), '_', 'bar_hitid_zoomed_96'];
        savefig([fn, '.fig']);
        print('-dbmp', [fn, '.bmp']);
