...
function pca_kinetic_pol_overlay_filter(x_min, x_max, y_min)
...
fprintf('\n');
disp('--> PCA kinetic pol overlay filter start');
fprintf('\n');
...
% Save plot.
savefig('pca_kinetic_pol_overlay_filter.fig');
print('-dbmp', 'pca_kinetic_pol_overlay_filter.bmp');
...
fprintf('\n');
disp('--> PCA kinetic pol overlay filter end');
fprintf('\n');
