...
function pca_kinetic_pol_overlay_3d
...
fprintf('\n');
disp('--> PCA kinetic pol overlay 3D start');
fprintf('\n');
...
CaptureFigVid([-20, 10; -110, 10; -190, 80; -290, 10; -380, 10], '3d_rotation', OptionZ);

% Save plot.
savefig('pca_kinetic_pol_overlay_3d.fig');
print('-dbmp', 'pca_kinetic_pol_overlay_3d.bmp');
