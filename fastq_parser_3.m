...
for bar = 1:length(bar_seqs) 
    ...
    % Navigate to '3 barcode' directory.
...
save('pol-bar_mixing_cons_3.mat', 'cons_list');
...
movefile('*cons_3*', 'mat_files');

% Navigate to working directory.
cd(work_dir);

fprintf('\n');
disp('--> FASTQ parser 3 end');
fprintf('\n');
