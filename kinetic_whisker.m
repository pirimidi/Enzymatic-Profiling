...
% featuring kinetic differences for each 'pol-bar' case displaying them on
% the same plot for comparison. NOTE: Use MATLAB R2017a to run this code, 
% older version might trigger errors. Vary 'pol', fix 'bar'.
%
% This software may be used, modified, and distributed freely, but this
% header may not be modified and must appear at the top of this file.
%--------------------------------------------------------------------------

function kinetic_whisker
...
for bar = 1:length(barcodes)
    ...
    cdir = ['kinetic_whisker_', barcodes{bar}];
