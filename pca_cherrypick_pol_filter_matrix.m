...
function pca_cherrypick_pol_filter_matrix(type, scaler)
...
fprintf('\n');
disp('--> PCA cherry pick filter matrix start');
fprintf('\n');
...
fprintf('\n');
disp('--> PCA cherry pick filter matrix end');
fprintf('\n');
