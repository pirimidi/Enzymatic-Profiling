...
function pca_kinetic_overlay_3d_filter(x_min, x_max, y_min)
...
fprintf('\n');
disp('--> PCA kinetic overlay 3D filter start');
fprintf('\n');
...
% Save plot.
savefig('pca_kinetic_overlay_3d_filter.fig');
print('-dbmp', 'pca_kinetic_overlay_3d_filter.bmp');
...
fprintf('\n');
disp('--> PCA kinetic overlay 3D filter end');
fprintf('\n');
