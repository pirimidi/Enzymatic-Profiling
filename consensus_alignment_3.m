...
%
% Purpose: This program receives a MAT-files, a collection of 3 barcode 
...
function consensus_alignment_3
...
fprintf('\n');
disp('--> Consensus alignment 3 start');
fprintf('\n');
...
for e = 1:length(list) 
    ...
    pp = strsplit(ss{1}, '_');
    save([pp{1}, '_mixing_cons_align_3.mat'], 'cons_list', '-v7.3');
    
    % Clear nanopore data structure per experimental set (pol-bar).
    clear(list(e).name);
...
fprintf('\n');
disp('--> Consensus alignment 3 end');
fprintf('\n');
