...
%
% Purpose: This program receives an experimental folder name ('96 barcodes'),
% iterates through all sub-directories, i.e., the repeated experiment 96 BC 
...
data_dir = strcat(work_dir, '\data\harvard');
cd(data_dir);
...
save('pol6-67_stats_96.mat', 'cells_list');

% Navigate to working directory.
cd(work_dir);

fprintf('\n');
disp('--> EXCEL parser 96 end');
fprintf('\n');
